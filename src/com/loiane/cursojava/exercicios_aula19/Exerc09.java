...
//2. This App stores 10 integers number in 2 array each and then replicate the result of the division
// of them terms to a third arrayC.
...
public class Exerc09 {
	...
	public static void main(String[] args) {
		...
		for (int count2 = 0; count2 < arrayC.length; count2++) {
			arrayC[count2] = arrayA[count2] / (double) arrayB[count2];
		}
		System.out.println("\n\nArrayC elements: ");

		for (double elem : arrayC) {
